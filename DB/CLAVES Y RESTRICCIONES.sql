...
--TABLA PRIVILEGIOS
ALTER TABLE PRIVILEGIOS ADD CONSTRAINT PK_idprivilegios PRIMARY KEY(id_privilegios);
ALTER TABLE PRIVILEGIOS ADD CONSTRAINT FK_idprivilegios FOREIGN KEY (id_rol) REFERENCES Rol;
