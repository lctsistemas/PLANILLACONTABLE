...
namespace Datos.Entities
{
    public class DPlanilla
    {
        ...
        public DPlanilla(int id_planilla, int id_tipo_planilla, int id_periodo, DateTime fecha_inicial, DateTime fecha_final, DateTime fecha_pago, int dias_mes, int horas_mes, decimal remu_basica, decimal asig_familiar, int tope_horario_nocturno)
        {
